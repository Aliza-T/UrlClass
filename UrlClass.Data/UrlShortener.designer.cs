...
namespace UrlClass.Data
{
    ...
    partial void DeleteUser(User instance);
		...
		public UrlShortenerDataContext() : 
				base(global::UrlClass.Data.Properties.Settings.Default.UrlShortenerConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnViewsChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ShortenedUrl", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		public string ShortenedUrl
		{
			...
			set
			{
				if ((this._ShortenedUrl != value))
				{
					this.OnShortenedUrlChanging(value);
					this.SendPropertyChanging();
					this._ShortenedUrl = value;
